...
const LeftDrawer = ({ isOpen, onCloseDrawer }) => {
        ...
        {login && (
          <ListItem key="Fav Cards" disablePadding>
            <ListItemButton onClick={handleFav}>
              ...
              <ListItemText primary="Fav Movies" />
            </ListItemButton>
          </ListItem>
        )}
        {login && (login.isBusiness || login.isAdmin) && (
          <ListItem key="My Movies" disablePadding>
            <ListItemButton onClick={handleMyMovies}>
              <ListItemIcon>
                <FeedIcon />
              </ListItemIcon>
